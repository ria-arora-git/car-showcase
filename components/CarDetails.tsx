        ...
        <Dialog as='div' className={'relative z-10 '} onClose={closeModel}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              <TransitionChild as={Fragment} enter='ease-out duration-300' enterFrom='opactiy-0 scale-95' enterTo='opacity-100 scale-100' leave='ease-in duration-200' leaveFrom='opacity-100 scale-100' leaveTo='opacity-0 scale-95'>
                <DialogPanel className={'relative w-full max-w-lg max-h-[90vh] overflow-y-auto transfrom rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-6 '}>
